<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科室类型" prop="keshileixing">
          <el-input v-model="ruleForm.keshileixing" 
              placeholder="科室类型" clearable  :readonly="ro.keshileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科室类型" prop="keshileixing">
              <el-input v-model="ruleForm.keshileixing" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='keshileixing'){
            this.ruleForm.keshileixing = obj[o];
	    this.ro.keshileixing = true;
            continue;
          }
          if(o=='yiyuanbianhao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yiyuankeshiyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yiyuankeshiyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
