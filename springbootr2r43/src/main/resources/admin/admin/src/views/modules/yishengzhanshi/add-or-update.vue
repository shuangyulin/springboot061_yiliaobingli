<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专业特长" prop="zhuanyetezhang">
          <el-input v-model="ruleForm.zhuanyetezhang" 
              placeholder="专业特长" clearable  :readonly="ro.zhuanyetezhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专业特长" prop="zhuanyetezhang">
              <el-input v-model="ruleForm.zhuanyetezhang" 
                placeholder="专业特长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gerenjianjie = true;
          ...
          if(o=='zhuanyetezhang'){
            this.ruleForm.zhuanyetezhang = obj[o];
	    this.ro.zhuanyetezhang = true;
            continue;
          }
          if(o=='yiyuanbianhao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yishengzhanshi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yishengzhanshiCrossAddOrUpdateFlag = false;
                  this.parent.search();
